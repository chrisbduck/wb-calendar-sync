...
export type SyncJob = { id: number; friendly_name: string; source_calendar_id: string; target_calendar_id: string; enabled: boolean; created_at: string | null; updated_at: string | null; last_run_at: string | null; last_status: string | null; last_error: string | null };
